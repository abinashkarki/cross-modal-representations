...
The earlier benchmark is unpublished prior work using the same 22-model roster
...
Code, data manifests, result artifacts, figure-generation scripts, and manuscript sources will be
made publicly available upon acceptance. Heavy compiled artifacts are indexed with SHA256 checksums
